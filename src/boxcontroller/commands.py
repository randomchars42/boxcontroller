...
class Commands():
    """Representation of the two commands files.

    Configuration can be set in three different ways:
    * APPLICATION_PATH/settings/commands (application's defaults)
    * ~/.config/boxcontroller/commands
    Whereas commands from the latter file override commands from the former.
    """
